const itineraries = {
  relax: {
    ...
    dimensions: {
      eat: "礁溪蔥油餅、頭城海鮮、羅東夜市小吃。",
      drink: "海景咖啡館、礁溪溫泉旅宿下午茶。",
      play: "湯圍溝公園、外澳海灘、羅東林場散步。",
      shop: "礁溪伴手禮店、羅東名產與蜜餞。"
    },
    days: [
      {
  ...
  family: {
    ...
    dimensions: {
      eat: "親子友善餐廳、夜市小吃、觀光工廠簡餐。",
      drink: "鮮奶飲、果汁、觀光工廠主題飲品。",
      play: "農場餵動物、傳藝手作、海邊放風。",
      shop: "青蔥伴手禮、傳藝文創、兒童零食。"
    },
    days: [
      {
        title: "Day 1｜農場互動日",
  ...
  outdoor: {
    ...
    dimensions: {
      eat: "登山前早餐店、海鮮料理、山下熱炒。",
      drink: "便利商店咖啡、山林茶飲、海邊飲料。",
      play: "抹茶山、太平山、烏石港海線活動。",
      shop: "太平山紀念品、海港特產、在地農產。"
    },
    days: [
      {
        title: "Day 1｜抹茶山挑戰",
  ...
  food: {
    ...
    dimensions: {
      eat: "羅東夜市、南方澳海鮮、宜蘭市場小吃。",
      drink: "礁溪咖啡店、甜點店、特色茶飲。",
      play: "文化工場散步、漁港看景、泡湯。",
      shop: "牛舌餅、鴨賞、蜜餞、海產乾貨。"
    },
    days: [
  ...
  senior: {
    ...
    dimensions: {
      eat: "礁溪合菜、宜蘭市區中式餐館、羅東小吃。",
      drink: "熱茶、溫泉旅宿茶點、咖啡館休息。",
      play: "足湯、公園散步、平地景點慢遊。",
      shop: "伴手禮店、養生食品、在地名產。"
    },
    days: [
  ...
  culture: {
    ...
    dimensions: {
      eat: "老宅早午餐、特色咖啡館、文青甜點。",
      drink: "手沖咖啡、茶飲、特色甜點飲品。",
      play: "傳藝手作、老街散步、展館參觀。",
      shop: "文創商品、手作小物、特色明信片。"
    },
    days: [
      {
        title: "Day 1｜宜蘭市文藝散步",
  ...
  budget: {
    ...
    dimensions: {
      eat: "平價便當、小吃攤、夜市銅板美食。",
      drink: "超商咖啡、平價手搖、早餐紅茶。",
      play: "免費公園、海邊散步、林場走走。",
      shop: "平價名產、夜市伴手禮、特價零食。"
    },
    days: [
      {
        title: "Day 1｜宜蘭市免費景點",
...
const budgetLevelSelect = document.getElementById("budgetLevel");
...
function renderPlan() {
  ...
  const budget = budgetLevelSelect.value;
  ...
  dimensionsEl.innerHTML = `
    <article class="dimension-card">
      <h3>吃</h3>
      <p>${plan.dimensions.eat}</p>
    </article>
    <article class="dimension-card">
      <h3>喝</h3>
      <p>${plan.dimensions.drink}</p>
    </article>
    <article class="dimension-card">
      <h3>玩</h3>
      <p>${plan.dimensions.play}</p>
    </article>
    <article class="dimension-card">
      <h3>買</h3>
      <p>${plan.dimensions.shop}</p>
    </article>
  `;
...
budgetLevelSelect.addEventListener("change", renderPlan);
